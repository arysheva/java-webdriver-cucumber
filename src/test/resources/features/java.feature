@java
  Feature: Java feature
    ...
    Scenario: Hello world
      ...
      And I perform actions with "var" and "VAR"
      And I perform actions with "team2 is the best" and "the best"
      And I perform actions with "Hello, world" and "Hello, world"
      And I perform actions with "Hello" and "world"
